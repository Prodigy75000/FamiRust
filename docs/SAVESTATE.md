...
**This core:** FamiRust's `save.rs` byte-cursor is the **reference implementation**
of this contract (little-endian, fixed field order, refuses bad states). Keep it
that way; add the golden-bytes test below.
