...
;
; MONKEY FARCE -- palettes, the screens, and the sound effect table.
...
end_script:
  .byte >(NT0+ 9*32+ 7), <(NT0+ 9*32+ 7)
  .str "YOU GOT OUT OF THE KEEP"
  .byte $FF
